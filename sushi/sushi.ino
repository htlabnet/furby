...
// ###########################################################
//
//      Furby Connect LCD 動作テストコード
//
//      Hideto Kikuchi / PJ (@pcjpnet) - http://pc-jp.net/
//      Takumi Sueda / puhitaku (@puhitaku)
//
// ###########################################################
//
//
//      Example Code for ESP32 Dev Module
//      Require LovyanGFX 0.3.12 Library
//
//
// ####################  LCD Pin Assignments  ####################
//  
...
// 20MHz, 16MHz, 13.4MHz, 11.5MHz, 10MHz, 88.9MHz, 8MHz, 7.3MHz, 6.7MHz
  ...
  lcd.fillScreen((uint16_t)0);
}


// ===== MAIN SUSHI LOOP ===== //
void loop() {
  lcd.pushImageRotateZoom(64, 64, 24, 24, i, 2.0, 2.0, 48, 48, sushi);
